  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">疫情期间社区出入管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="住址" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.zhuzhi" autocomplete="off" placeholder="住址"  />
			</el-form-item>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210223/8f8d1158257649aaa57af29dc1c278f0.png");
		height: 100vh;
