<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="住址" prop="zhuzhi">
          <el-input v-model="ruleForm.zhuzhi" 
              placeholder="住址" clearable  :readonly="ro.zhuzhi"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="出入情况" prop="churuqingkuang">
          <el-select v-model="ruleForm.churuqingkuang" placeholder="请选择出入情况">
            <el-option
                v-for="(item,index) in churuqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="出入情况" prop="churuqingkuang">
	      <el-input v-model="ruleForm.churuqingkuang"
                placeholder="出入情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="出入时间" prop="churushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.churushijian" label="出入时间" prop="churushijian">
              <el-input v-model="ruleForm.churushijian" 
                placeholder="出入时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出入去向" prop="churuquxiang">
          <el-input v-model="ruleForm.churuquxiang" 
              placeholder="出入去向" clearable  :readonly="ro.churuquxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出入去向" prop="churuquxiang">
              <el-input v-model="ruleForm.churuquxiang" 
                placeholder="出入去向" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuzhi = true;
          ...
          if(o=='churuqingkuang'){
            this.ruleForm.churuqingkuang = obj[o];
	    this.ro.churuqingkuang = true;
            continue;
          }
          if(o=='churushijian'){
	    ...
	    this.ro.churushijian = true;
          ...
          if(o=='churuquxiang'){
            this.ruleForm.churuquxiang = obj[o];
	    this.ro.churuquxiang = true;
            continue;
          }
          if(o=='tiwen'){
      ...
      this.$http({
		...
		if(json.zhaopian!=''&&json.zhaopian){
          ...
          this.$message.error(data.msg);
            ...
            this.churuqingkuangOptions = "出,入".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
